...
*                       =======
*
* This file contains all the public PM error codes.  They all have a
* definition commencing PMERR_
*
...
#define WINDBG_WINDOW_UNLOCK_WAIT           0x1035                   /* jek */
#define PMERR_NO_MSG_QUEUE                  0x1036
#define PMERR_WIN_DEBUGMSG                  0x1037
#define PMERR_QUEUE_FULL                    0x1038

#define PMERR_LIBRARY_LOAD_FAILED           0x1039                   /*@DIA*/
#define PMERR_PROCEDURE_LOAD_FAILED         0x103A                   /*@DIA*/
#define PMERR_LIBRARY_DELETE_FAILED         0x103B                   /*@DIA*/
#define PMERR_PROCEDURE_DELETE_FAILED       0x103C                   /*@DIA*/
                                                                     /*@DIA*/
#define PMERR_ARRAY_TOO_LARGE               0x103D                   /*@DHA*/
#define PMERR_ARRAY_TOO_SMALL               0x103E                   /*@DHA*/
#define PMERR_DATATYPE_ENTRY_BAD_INDEX      0x103F                   /*@DHA*/
#define PMERR_DATATYPE_ENTRY_CTL_BAD        0x1040                   /*@DHA*/
#define PMERR_DATATYPE_ENTRY_CTL_MISS       0x1041                   /*@DHA*/
#define PMERR_DATATYPE_ENTRY_INVALID        0x1042                   /*@DHA*/
#define PMERR_DATATYPE_ENTRY_NOT_NUM        0x1043                   /*@DHA*/
#define PMERR_DATATYPE_ENTRY_NOT_OFF        0x1044                   /*@DHA*/
#define PMERR_DATATYPE_INVALID              0x1045                   /*@DHA*/
#define PMERR_DATATYPE_NOT_UNIQUE           0x1046                   /*@DHA*/
#define PMERR_DATATYPE_TOO_LONG             0x1047                   /*@DHA*/
#define PMERR_DATATYPE_TOO_SMALL            0x1048                   /*@DHA*/
#define PMERR_DIRECTION_INVALID             0x1049                   /*@DHA*/
#define PMERR_INVALID_HAB                   0x104A                   /*@DHA*/
#define PMERR_INVALID_HSTRUCT               0x104D                   /*@DHA*/
#define PMERR_LENGTH_TOO_SMALL              0x104E                   /*@DHA*/
#define PMERR_MSGID_TOO_SMALL               0x104F                   /*@DHA*/
#define PMERR_NO_HANDLE_ALLOC               0x1050                   /*@DHA*/
...
#define PMERR_INVALID_INI_FILE_HANDLE    0x1115                       /* @D3A */
#define PMERR_MEMORY_SHARE               0x1116                       /* @D3A */
#define PMERR_OPEN_QUEUE                 0x1117                       /* @D3A */
#define PMERR_CREATE_QUEUE               0x1118                       /* @D3A */
#define PMERR_WRITE_QUEUE                0x1119                       /* @D3A */
#define PMERR_READ_QUEUE                 0x111A                       /* @D3A */
#define PMERR_CALL_NOT_EXECUTED          0x111B                       /* @D3A */
#define PMERR_UNKNOWN_APIPKT             0x111C                       /* @D3A */
#define PMERR_INITHREAD_EXISTS           0x111D                       /* @D3A */
#define PMERR_CREATE_THREAD              0x111E                       /* @D3A */
#define PMERR_NO_HK_PROFILE_INSTALLED    0x111F                       /* @D3A */
#define PMERR_INVALID_DIRECTORY          0x1120                       /* @D3A */
#define PMERR_WILDCARD_IN_FILENAME       0x1121                       /* @D3A */
#define PMERR_FILENAME_BUFFER_FULL       0x1122                       /* @D3A */
#define PMERR_FILENAME_TOO_LONG          0x1123                       /* @D3A */
#define PMERR_INI_FILE_IS_SYS_OR_USER    0x1124                       /* @D3A */
#define PMERR_BROADCAST_PLMSG            0x1125                       /* @D3A */
#define PMERR_190_INIT_DONE              0x1126                       /* @D3A */
#define PMERR_HMOD_FOR_PMSHAPI           0x1127                       /* @D3A */
#define PMERR_SET_HK_PROFILE             0x1128                       /* @D3A */
#define PMERR_API_NOT_ALLOWED            0x1129                       /* @D3A */
#define PMERR_INI_STILL_OPEN             0x112A                       /* @D3A */

#define PMERR_PROGDETAILS_NOT_IN_INI     0x112B                       /* @P1A */
#define PMERR_PIBSTRUCT_NOT_IN_INI       0x112C                       /* @P1A */
#define PMERR_INVALID_DISKPROGDETAILS    0x112D                       /* @P1A */
#define PMERR_PROGDETAILS_READ_FAILURE   0x112E                       /* @P1A */
#define PMERR_PROGDETAILS_WRITE_FAILURE  0x112F                       /* @P1A */
#define PMERR_PROGDETAILS_QSIZE_FAILURE  0x1130                       /* @P1A */
#define PMERR_INVALID_PROGDETAILS        0x1131                       /* @P1A */
#define PMERR_SHEPROFILEHOOK_NOT_FOUND   0x1132                      /* @D12A */
#define PMERR_190PLCONVERTED             0x1133               /* @D11A @D12C */
#define PMERR_FAILED_TO_CONVERT_INI_PL   0x1134               /* @D11A @D12C */
...
#define PMERR_NO_ENTRIES_IN_GROUP        0x1305               /* @D10A */
...
#define PMERR_GROUP_PROTECTED            0x151F               /* @D3A */
#define PMERR_INVALID_PROGRAM_CATEGORY   0x152F               /* @D3A */
#define PMERR_INVALID_APPL               0x1530               /* @D1A */
#define PMERR_CANNOT_START               0x1531               /* @D1A */
#define PMERR_STARTED_IN_BACKGROUND      0x1532               /* @D1A */
#define PMERR_INVALID_HAPP               0x1533               /* @D4A */
#define PMERR_CANNOT_STOP                0x1534               /* @D4A */

/*                                                                    */
/* Errors generated by Language Bindings layer.                  @D5. */
/*                                                                    */
/* (Range 0x1600 thru 0x16FF reserved for Bindings)              @D5A */
/*                                                                    */

/* SEVERITY_UNRECOVERABLE:                                       @D5A */

#define PMERR_INTERNAL_ERROR_1           0x1601               /* @D5. */
#define PMERR_INTERNAL_ERROR_2           0x1602               /* @D5. */
#define PMERR_INTERNAL_ERROR_3           0x1603               /* @D5. */
#define PMERR_INTERNAL_ERROR_4           0x1604               /* @D5. */
#define PMERR_INTERNAL_ERROR_5           0x1605               /* @D5. */
#define PMERR_INTERNAL_ERROR_6           0x1606               /* @D5. */
#define PMERR_INTERNAL_ERROR_7           0x1607               /* @D5. */
#define PMERR_INTERNAL_ERROR_8           0x1608               /* @D5. */
#define PMERR_INTERNAL_ERROR_9           0x1609               /* @D5. */
#define PMERR_INTERNAL_ERROR_10          0x160A               /* @D5. */
#define PMERR_INTERNAL_ERROR_11          0x160B               /* @D5. */
#define PMERR_INTERNAL_ERROR_12          0x160C               /* @D9A */
#define PMERR_INTERNAL_ERROR_13          0x160D               /* @D9A */
#define PMERR_INTERNAL_ERROR_14          0x160E               /* @D9A */
#define PMERR_INTERNAL_ERROR_15          0x160F               /* @D9A */
#define PMERR_INTERNAL_ERROR_16          0x1610               /* @D9A */
#define PMERR_INTERNAL_ERROR_17          0x1611               /* @D9A */
#define PMERR_INTERNAL_ERROR_18          0x1612               /* @D9A */
#define PMERR_INTERNAL_ERROR_19          0x1613               /* @D9A */
#define PMERR_INTERNAL_ERROR_20          0x1614               /* @D9A */
#define PMERR_INTERNAL_ERROR_21          0x1615               /* @D9A */
#define PMERR_INTERNAL_ERROR_22          0x1616               /* @D9A */
#define PMERR_INTERNAL_ERROR_23          0x1617               /* @D9A */
#define PMERR_INTERNAL_ERROR_24          0x1618               /* @D9A */
#define PMERR_INTERNAL_ERROR_25          0x1619               /* @D9A */
#define PMERR_INTERNAL_ERROR_26          0x161A               /* @D9A */
#define PMERR_INTERNAL_ERROR_27          0x161B               /* @D9A */
#define PMERR_INTERNAL_ERROR_28          0x161C               /* @D9A */
#define PMERR_INTERNAL_ERROR_29          0x161D               /* @D9A */

/* SEVERITY_WARNING:                                             @D9A */

#define PMERR_INVALID_FREE_MESSAGE_ID    0x1630               /* @D9A */

/* SEVERITY_ERROR:                                               @D5A */

#define PMERR_FUNCTION_NOT_SUPPORTED     0x1641               /* @D5. */
#define PMERR_INVALID_ARRAY_COUNT        0x1642               /* @D9C */
#define PMERR_INVALID_LENGTH             0x1643               /* @D9C */
#define PMERR_INVALID_BUNDLE_TYPE        0x1644               /* @D9C */
#define PMERR_INVALID_PARAMETER          0x1645               /* @D9A */
#define PMERR_INVALID_NUMBER_OF_PARMS    0x1646               /* @D9A */
#define PMERR_GREATER_THAN_64K           0x1647               /* @D9A */
#define PMERR_INVALID_PARAMETER_TYPE     0x1648               /* @D9A */
#define PMERR_NEGATIVE_STRCOND_DIM       0x1649               /* @D9A */
#define PMERR_INVALID_NUMBER_OF_TYPES    0x164A               /* @D9A */
#define PMERR_INCORRECT_HSTRUCT          0x164B               /* @D9A */
#define PMERR_INVALID_ARRAY_SIZE         0x164C               /* @D9A */
#define PMERR_INVALID_CONTROL_DATATYPE   0x164D               /* @D9A */
#define PMERR_INCOMPLETE_CONTROL_SEQU    0x164E               /* @D9A */
#define PMERR_INVALID_DATATYPE           0x164F               /* @D9A */
#define PMERR_INCORRECT_DATATYPE         0x1650               /* @D9A */
#define PMERR_NOT_SELF_DESCRIBING_DTYP   0x1651               /* @D9A */
#define PMERR_INVALID_CTRL_SEQ_INDEX     0x1652               /* @D9A */
#define PMERR_INVALID_TYPE_FOR_LENGTH    0x1653               /* @D9A */
#define PMERR_INVALID_TYPE_FOR_OFFSET    0x1654               /* @D9A */
#define PMERR_INVALID_TYPE_FOR_MPARAM    0x1655               /* @D9A */
#define PMERR_INVALID_MESSAGE_ID         0x1656               /* @D9A */
#define PMERR_C_LENGTH_TOO_SMALL         0x1657               /* @D9A */
#define PMERR_APPL_STRUCTURE_TOO_SMALL   0x1658               /* @D9A */
#define PMERR_INVALID_ERRORINFO_HANDLE   0x1659               /* @D9A */
#define PMERR_INVALID_CHARACTER_INDEX    0x165A               /* @D9A */

/*                                                                    */
/* End of Errors generated by Language Bindings layer.           @D5A */
/*                                                                    */
/* (Range 0x1600 thru 0x16FF reserved for Bindings)              @D5A */
/*                                                                    */
...
#define PMERR_INV_FLOOD_FILL_OPTIONS       0x210D                     /*@D15A*/
#define PMERR_INV_FACENAME                 0x210E                     /*@D16A*/
#define PMERR_PALETTE_SELECTED             0x210F                     /*@D17A*/
#define PMERR_NO_PALETTE_SELECTED          0x2110                     /*@D17A*/
#define PMERR_INV_HPAL                     0x2111                     /*@D17A*/
#define PMERR_PALETTE_BUSY                 0x2112                     /*@D17A*/
#define PMERR_START_POINT_CLIPPED          0x2113                     /*@D18A*/
#define PMERR_NO_FILL                      0x2114                     /*@D18A*/
#define PMERR_INV_FACENAMEDESC             0x2115                     /*@P2 A*/
