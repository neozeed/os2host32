...
#define CAPS_LINEWIDTH_THICK           40L                      /*@D2A*/
...
#define CAPS_COLOR_CURSOR_SUPPORT      128L                     /*@D3A*/
#define CAPS_PALETTE_MANAGER           256L                     /*@D3A*/
#define CAPS_COSMETIC_WIDELINE_SUPPORT 512L                     /*@D2A*/
...
#define CAPS_RASTER_FLOOD_FILL         64L                           /* @D1A */

#ifndef INCL_DDIDEFS
/* XLATOFF */
#ifdef INCL_16
    #define DevOpenDC            Dev16OpenDC
    #define DevCloseDC           Dev16CloseDC
    #define DevQueryCaps         Dev16QueryCaps
#endif  /* INCL_16 */
/* XLATON */
...
/* structure for DEVESC_GETSCALINGFACTOR */                      /*@P1A*/
typedef struct _SFACTORS { /* sfactors */                        /*@P1A*/
    LONG x;                                                      /*@P1A*/
    LONG y;                                                      /*@P1A*/
} SFACTORS;                                                      /*@P1A*/
typedef SFACTORS FAR * PSFACTORS;                                /*@P1A*/

/* structure for DEVESC_NEXTBAND */                              /*@P1A*/
typedef struct _BANDRECT { /* bandrect */                        /*@P1A*/
    LONG  xleft;                                                 /*@P1A*/
    LONG  ybottom;                                               /*@P1A*/
    LONG  xright;                                                /*@P1A*/
    LONG  ytop;                                                  /*@P1A*/
} BANDRECT;                                                      /*@P1A*/
typedef BANDRECT FAR * PBANDRECT;                                /*@P1A*/
...
/* XLATOFF */
#ifdef INCL_16
    #define DevEscape            Dev16Escape
    #define DevQueryDeviceNames  Dev16QueryDeviceNames
    #define DevQueryHardcopyCaps Dev16QueryHardcopyCaps
    #define DevPostDeviceModes   Dev16PostDeviceModes
#endif  /* INCL_16 */
/* XLATON */
