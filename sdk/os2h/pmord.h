...
/* XLATOFF */
#pragma pack(1)      /* pack on byte boundary                    @P3A*/
/* XLATON */
...
/* Escape (DrawBits) */                                                /* @D1A*/
#define GEDB_REGID     0x04          /* uchIdent - DrawBits */         /* @D1A*/
                                                                       /* @D1A*/
#define ETYPE_GEDB          0x800400D5L                                /* @D1A*/
                                                                       /* @D1A*/
typedef struct _ORDERL_GEDB {   /* olgedb */                           /* @D1A*/
  USHORT      fsFlags;                                                 /* @D1A*/
  USHORT      usMix;                                                   /* @D1A*/
  PVOID       pBits;                                                   /* @D1A*/
  PBITMAPINFO2 pbmi;                                                   /* @D3C*/
  LONG        lOptions;                                                /* @D1A*/
  RECTL       rclTargetRect;                                           /* @D1A*/
  RECTL       rclSourceRect;                                           /* @D1A*/
} ORDERL_GEDB;                                                         /* @D1A*/


/* Escape (FloodFill) */                                               /* @D2A*/
#define GEFF_REGID     0x03          /* uchIdent - FloodFill */        /* @D2A*/

#define ETYPE_GEFF          0x800300D5L                                /* @D2A*/

typedef struct _ORDERL_GEFF {   /* olgeff */                           /* @D2A*/
  UCHAR       fsFlags;                                                 /* @D2A*/
  UCHAR       auchColor[3];                                            /* @D2A*/
} ORDERL_GEFF;                                                         /* @D2A*/
...
#define GCCHSTE_DEEMPHASIZE   0x20            /* Reserved        @P2C*/
#define GCCHSTE_NODEEMPHASIZE 0x00
#define GCCHSTE_LEAVEPOS      0x10
#define GCCHSTE_MOVEPOS       0x00
#define GCCHSTE_UNDERSCORE    0x08                            /* @P2A*/
#define GCCHSTE_NOUNDERSCORE  0x00                            /* @P2A*/
#define GCCHSTE_STRIKEOUT     0x04                            /* @P2A*/
#define GCCHSTE_NOSTRIKEOUT   0x00                            /* @P2A*/
...
typedef struct _ORDER_GEESCP {  /* ogeescp */
  ...
  UCHAR  auchData[GEESCP_ML];
                                   ...
                                   /*                            @P3A*/
/* XLATOFF */
#pragma pack()    /* reset to default packing                    @P3A*/
/* XLATON */
